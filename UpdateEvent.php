...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="UpdateEvent.css?v=<?php echo time(); ?>">
        ...
        <div class="col-10 offset-md-2 offset-sm-3 offset-6" >
            <div class="row">
                ...
                <form action="update.php" method="POST">
                    <input type="text" placeholder="Event Id" name="EventId" value="<?php echo($_GET['cust_id'])?>">
                    ...
                    <input type="text" placeholder="Attendees" name="Attendees">
                    <br><br>
                    <input type="submit" value="UpdateEvent" name="submit">
            </form>
            </div
        </div>
    </div>
